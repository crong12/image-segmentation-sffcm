function show_results(I,boundariesPred,boundariesHuman,f1score,TP,FP,FN)
%Function used to show comparison between predicted and human image segmentations.

maxsubplot(2,3,4); imagescc(I); title('Original image')
maxsubplot(2,3,5); imagescc(boundariesPred); title('Predicted Boundaries')
...
maxsubplot(2,3,6); imagescc(mean(boundariesHuman,3)); title('Human Boundaries')
